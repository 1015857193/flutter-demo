...
import '../dio_util/dio_cache_interceptors.dart';
import '../dio_util/dio_interceptors.dart';
import '../dio_util/dio_method.dart';
import '../dio_util/dio_token_interceptors.dart';
import '../dio_util/dio_transformer.dart';
...
class DioUtil {
  ...
  /// 请求的URL前缀
  static String BASE_URL = "http://apis.juhe.cn";
  /// 是否开启网络缓存,默认false
  static bool CACHE_ENABLE = true;
